...
$sql=mysqli_query($conn,"select * from exam_form where class='FE'");

if(isset($_GET['id']) && isset($_GET['status'])) {
    $id=$_GET['id'];
    $status=$_GET['status'];
    mysqli_query($conn,"update exam_form set status='$status' where id='$id'");
    header("location:fe_exam_form_status.php");
}
?>
<html>
    <head>
        ...
        <title>Fe Exam Form status</title>
        <style type="text/css">
        ...
        <div class="container">
            ...
            <script type="text/javascript">
                function status_update(value,id){
                    //alert(id);
                    let url="http://localhost/Final_year/fe_exam_form_status.php";
