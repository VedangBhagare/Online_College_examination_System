<?php 
     ...
     $sql ="select * from exam_form where id='$id'";
...
<html>  
<head>  
    <title> Exam Form Verification Mail </title>  
...
if(isset($_REQUEST['send_mail']))
{
  ...
  $email = $_REQUEST['email'];
  $check_email = mysqli_query($conn,"select email from exam_form where email='$email'");
  $res = mysqli_num_rows($check_email);
  if($res>0)
  {
    $message = '<div>
     <p><b>Hello!</b></p>
     <p>Dear Student Your Exam Form is Verified Successfully... 
     <br>
      <p>You can make Payment using following Link ..</p>
     <p><a href="vedang.24.bhagare@oksbi">vedang.24bhagare@oksbi</a></p>
     <br>
...
$mail->AddAddress($email);
$mail->Subject = "Exam Form Verification Mail";
$mail->isHTML( TRUE );
$mail->Body =$message;
...
<button class="button" style="background-color:rgb(62, 5, 67); color: rgb(241, 241, 236); text-decoration:solid; font-weight: bold;font-size: 30px;" >Email Page</button>
<button style="background-color:rgb(10, 112, 171); color: azure; float: right; vertical-align:middle" class="button " onclick="location.href='../verify_exam_form.php'"><span>BACK</span></button>
<br>
<br>
<br>
<br>
...
<div class="container">  
    ...
    <h3 align="center">Exam Form Verification Mail </h3><br/>
    <div class="box">
    <?php 
        $con= mysqli_connect("localhost" , "root","","be_proj");
        error_reporting(0);
     ...
     $query ="select * from exam_form where id='$id'";
