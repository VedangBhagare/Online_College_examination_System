...
$sql=mysqli_query($conn,"select * from exam_form where mail_status='2'");

if(isset($_GET['id']) && isset($_GET['status'])) {
    $id=$_GET['id'];
    $status=$_GET['status'];
    mysqli_query($conn,"update exam_form set status='$status' where id='$id'");
    header("location:ceo_all_exam_form_status.php");
}
?>
<html>
    <head>
        ...
        <title>Verified Exam forms</title>
        <style type="text/css">
    ...
    <button class="button" style="background-color:rgb(62, 5, 67); color: rgb(241, 241, 236); text-decoration:solid; font-weight: bold;font-size: 30px;" >Exam Forms</button>
