...
$sql=mysqli_query($conn,"select * from exam_form where class='TE' and department='mechanical' and divi='b'");

if(isset($_GET['id']) && isset($_GET['status'])) {
    $id=$_GET['id'];
    $status=$_GET['status'];
    mysqli_query($conn,"update exam_form set status='$status' where id='$id'");
    header("location:update_status_mech_te_b.php");
}
?>
<html>
    <head>
        ...
        <title>Mechanical TE B Exam Form status</title>
        <style type="text/css">
    ...
    <button class="button" style="background-color:rgb(62, 5, 67); color: rgb(241, 241, 236); text-decoration:solid; font-weight: bold;font-size: 30px;" >Mechanical TE B Exam Forms</button>
        ...
        <div class="container">
            ...
            <script type="text/javascript">
                function status_update(value,id){
                    //alert(id);
                    let url="http://localhost/Final_year/update_status_mech_te_b.php";
