...
<body>
    ...
    <!-- <button class="button button2" style="background-color: rgb(62, 5, 67); color: white; text-decoration: solid; padding: 20px 50px;" onclick="location.href='verify_exam_form.php'"><span>Exam Form Status</span></button> -->
    ...
    <div class="navbar" >
        <ul>
            <br><br><br><br><br><br>
            <!-- <button class="button button2" style="background-color: #654caf; color: white; text-decoration: solid; padding: 20px 50px;" onclick="location.href='fe_verified_exam_form.php'"><span>FE</span></button> -->
            
            <br><br>
            <button class="button button2" style="background-color: #c91922; color: white; text-decoration: solid; padding: 20px 65px;" onclick="location.href='ceo_all_exam_form_status.php'" ><span>Exam Forms</span></button>
            <br><br>
